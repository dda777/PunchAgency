<header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
    ...
    <nav class="-mx-3 flex flex-1 justify-center">
        <div id="task-summary" class="mt-2">Выполненные задачи: 0/0</div>
    </nav>
...
<main class="container" id="container">
    ...
    <button id="open-task-form-modal"
            class="bg-blue-500 text-white py-2 px-4 rounded-md shadow-sm hover:bg-blue-600">Создать задачу
    </button>
