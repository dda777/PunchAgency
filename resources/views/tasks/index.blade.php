<header class="flex items-center flex-wrap justify-between">
    ...
    <nav class="mx-3 justify-end flex">
        <button class="focus:outline-none text-white bg-gray-400 hover:bg-gray-500 focus:ring-4 focus:ring-gray-300 font-medium rounded-md p-3 mr-2" id="settings">
